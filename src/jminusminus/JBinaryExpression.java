...
/**
 * The AST node for a divition (/) expression.
 */

class JDivitionOp extends JBinaryExpression {
    ...
    public JDivitionOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "/", lhs, rhs);
    }
    ...
    /**
     * Generating code for the / operation involves generating code for the two
     * operands, and then the divition instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
/**
 * The AST node for a module (%) expression.
 */
